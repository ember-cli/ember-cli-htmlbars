  ...
  return {
    ...
    visitor: {
      ...
      ExportDefaultDeclaration(path, state) {
        ...
        let setComponentTemplateMemberExpression =
          makeSetComponentTemplateExpression(state);
        ...
        if (defaultExportDeclaration.type === 'ClassDeclaration') {
          ...
          if (defaultExportDeclaration.id !== null) {
            ...
            path.node.declaration = t.callExpression(
              setComponentTemplateMemberExpression,
              [
                colocatedTemplateIdentifier,
                t.classExpression(
                  null,
          ...
          path.node.declaration = t.callExpression(
            setComponentTemplateMemberExpression,
            [colocatedTemplateIdentifier, defaultExportDeclaration],
          );
        }
      },
