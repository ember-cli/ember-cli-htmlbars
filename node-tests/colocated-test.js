...
describe('Colocation - Broccoli + Babel Integration (modules API: true)', function () {
  this.timeout(10000);
...
describe('Colocation - Broccoli + Babel Integration (modules API: false)', function () {
  this.timeout(10000);
      ...
      'app-name-here': {
        components: {
          'foo.js': `
            ...
            import templateOnly from '@ember/component/template-only';
            export default _setComponentTemplate(__COLOCATED_TEMPLATE__, templateOnly());
          `,
        },
        templates: {
          'application.hbs': '{{outlet}}',
      ...
      'app-name-here': {
        components: {
          'foo.js': `
            ...
            _setComponentTemplate(__COLOCATED_TEMPLATE__, FooComponent);
          `,
        },
        templates: {
          'application.hbs': '{{outlet}}',
